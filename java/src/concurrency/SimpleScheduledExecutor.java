...
public class SimpleScheduledExecutor implements ScheduledExecutor {
	...
	public SimpleScheduledExecutor(int threadPoolSize) {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		SimpleScheduledExecutor sse = new SimpleScheduledExecutor(3);
